 ...
 * };
 *
 * Optimized: standard Floyd's tortoise-and-hare with clearer naming.
 * Both pointers start at head; advance first, then compare.
 * Eliminates the redundant head->next == NULL early check.
 */
