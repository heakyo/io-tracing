 ...
 * 1. Early termination: if no swaps occur in a pass, the array is sorted.
 * 2. Shrinking boundary: track the last swap position to skip already-sorted
 *    tail elements more aggressively than the basic "len - 1 - i" bound.
 */
